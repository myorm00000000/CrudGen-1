...
The ``SensioCrudGenBundle`` extends the default Symfony2 command line
...
Then, like for any other bundle, include it in your Kernel class::
    ...
    public function registerBundles()
    {
        $bundles = array(
            ...
            new Sensio\Bundle\CrudGenBundle\SensioCrudGenBundle(),
        );
...
The ``SensioCrudGenBundle`` come with four new commands that can be run in
...
.. _Download: http://github.com/sensio/SensioCrudGenBundle